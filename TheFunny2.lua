    ...
    if not Typing then
        if Key.KeyCode == Enum.KeyCode[Config.FlingHotkey] then
            if Config.Permanent then
                ...
                Player.Character.Humanoid.RootPart.Velocity = (Player.Character.Humanoid.RootPart.Velocity + Vector3.new(0, 150, 0)) + (workspace.CurrentCamera.CFrame.LookVector * 200)
                ...
                RootPart.Velocity = (RootPart.Velocity + Vector3.new(0, 150, 0)) + (workspace.CurrentCamera.CFrame.LookVector * 200)
